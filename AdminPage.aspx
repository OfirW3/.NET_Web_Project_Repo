...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
    <td><asp:DropDownList ID="DDlFilter" runat="server"></asp:DropDownList></td>
    <td><asp:TextBox ID="TxtFilter" runat="server"></asp:TextBox></td>
    <td><asp:Button ID="BtnFilter" runat="server" Text="Filter"  OnClick= "BtnFilter_Click"/></td>
    <td> <asp:Button ID="BtnSort" runat="server" Text="Sort"  OnClick= "DDlSort_SelectedIndexChanged"/></td>
     </tr>
        <tr>
